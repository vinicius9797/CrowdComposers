...
i) {
    ...
    s.prototype= {
        init: function() {
            ...
            this._player=t("<audio />").data("audIndex",
            0),
        ...
        ,
        getAudioTimeDecrement:function(t,
        e) {
        ...
        onSongChange:function(t) {
            ...
            "function"==typeof this.opts.onAudioChange&&this.opts.onAudioChange.apply(this,
            [a])
        }
        ,
        ...
        attachEvents:function() {
            ...
            this.playPauseBut.on("click",
            function() {
                e._audio.paused?e.play(): e.pause()
            }
            ),
            t(this._audio).on("play",
            function() {
